...
MarkBox.prototype = {
    ...
    createMarkBox: function(w, h) {
        ...
        if (flag) {
            ...
            //弹窗标题样式设置
            var html = "<div style='line-height:40px;height:40px;padding-left:10px;width:" + w +
             ";background:white;'><span>" + this.title + 
             "</span><span id='closeId' style='float:right;color:black;line-height:40px;margin-right:5px;cursor:pointer'>关闭</span></div>";
